 ...
 * =============
 *
 * This commonJS module loads the fifth window. It sets all the display
...
function loadWindowFiveDisplay(inParam) {"use strict";
    ...
    var windowText    =    Ti.UI.createLabel({
        ...
        right :    10,
        height :    40,
        text :    Ti.Locale.getString('fiveLabel'),
...
exports.loadWindowFiveDisplay    =    loadWindowFiveDisplay;
